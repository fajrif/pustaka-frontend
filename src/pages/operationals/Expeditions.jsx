...
const MasterExpedition = () => {
  ...
  const deleteMutation = useMutation({
    ...
    onError: (error) => {
      toast({
        title: "Error",
        description: error.response?.data?.error || "Gagal menghapus ekspedisi.",
        variant: "destructive",
      });
    }
  });
    ...
    <div className="p-4 md:p-8 bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-2xl font-semibold text-slate-900">Master Data Ekspedisi</h1>
                    ...
                    <CardHeader className="pb-3">
                      <div className="flex justify-between items-start">
                        <div className="flex justify-center items-center gap-4">
                          {expedition.logo_url && (
                            <img
                              src={getAssetUrl(expedition.logo_url)}
                              alt="expedition Logo"
                          ...
                          <div className="flex-1">
                            <Badge variant="outline" className="bg-slate-50 text-slate-700 border-slate-200">{expedition.code}</Badge>
