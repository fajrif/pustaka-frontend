...
const CreditsFilterDialog = ({ isOpen, onClose, currentFilters, onApplyFilters }) => {
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                options={[
                  ...
                  ...salesAssociatesData.sales_associates.map((item) => ({
                    value: item.id,
                    label: item.name
                  }))
                ]}
                value={filters.sales_associate_id}
                onChange={(value) => handleFilterChange('sales_associate_id', value)}
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onChange={(value) => handleFilterChange('overdue_only', value)}
...
export default CreditsFilterDialog;
